...
**The problem with J-Lens**: we want the contribution of $h_\ell$ to the output $h_L$, which is not exactly the same as the Jacobian $\frac{\partial h_L}{\partial h_\ell}$., which is how a _delta_ to $h_\ell$ would get propagated to $h_L$.
...
- ![](/assets/img/distillations/r-lens-making-j-lens-more-faithful-on-early-layers/img-1787354313208.png)
