...
Any iterative algorithm can be converted to an ODE by just letting x\_i \= x(t + ∆t) and x\_{i-1} \= x(t), and then you also have to make your learning rate a continuously evolving function of time
