...
_Layer ablations and re-scaling text embeddings pre-attention to figure out which layers are most relevant to specific properties like color, spatial relationships, and count. Then applying this rescaling of text embeddings to make generated and edited images more aligned with text prompts._
